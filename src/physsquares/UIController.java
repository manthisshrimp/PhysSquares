...
public class UIController extends Controller {
    ...
    private final EntityUpdater momentumUpdater;
    ...
    private final Font OPTION_FONT = new Font("Monospaced", Font.PLAIN, 12);
    ...
    public UIController(Updater updater, Renderer renderer, InputHandler inputHandler,
            SquareCore core, EntityUpdater momentumUpdater) {
        super(updater, renderer, inputHandler);
        this.core = core;
        this.momentumUpdater = momentumUpdater;
        menuX = core.getContentResolution().width / 2 - MENU_WIDTH / 2;
        menuY = core.getContentResolution().height / 2 - MENU_HEIGHT / 2;
        initComponents();
    }

    private void initComponents() {
        // Lables and sliders:
        entityCountLabel = new Label(menuX + 5, menuY + 5, 100, 25, "Squares: ", OPTION_FONT, inputHandler, MENU_FOREGROUND, MENU_BACKGROUND);
        entityCountSlider = new Slider(menuX + MENU_WIDTH - 390 - 10, menuY + 5, 390, 25, inputHandler, 0, 10000, 750);
        entityCountSlider.setBackgroundColorAll(MENU_BACKGROUND);
        minEntitySizeLabel = new Label(menuX + 5, menuY + 30, 100, 25, "Min Size: ", OPTION_FONT, inputHandler, MENU_FOREGROUND, MENU_BACKGROUND);
        minEntitySizeSlider = new Slider(menuX + MENU_WIDTH - 390 - 10, menuY + 30, 390, 25, inputHandler, 1, 100, 1);
        minEntitySizeSlider.setBackgroundColorAll(MENU_BACKGROUND);
        maxEntitySizeLabel = new Label(menuX + 5, menuY + 55, 100, 25, "Max Size: ", OPTION_FONT, inputHandler, MENU_FOREGROUND, MENU_BACKGROUND);
        maxEntitySizeSlider = new Slider(menuX + MENU_WIDTH - 390 - 10, menuY + 55, 390, 25, inputHandler, 1, 100, 3);
        maxEntitySizeSlider.setBackgroundColorAll(MENU_BACKGROUND);
        minEntityMassLabel = new Label(menuX + 5, menuY + 80, 100, 25, "Min Mass: ", OPTION_FONT, inputHandler, MENU_FOREGROUND, MENU_BACKGROUND);
        minEntityMassSlider = new Slider(menuX + MENU_WIDTH - 390 - 10, menuY + 80, 390, 25, inputHandler, 1, 5000, 100);
        minEntityMassSlider.setBackgroundColorAll(MENU_BACKGROUND);
        maxEntityMassLabel = new Label(menuX + 5, menuY + 105, 100, 25, "Max Mass: ", OPTION_FONT, inputHandler, MENU_FOREGROUND, MENU_BACKGROUND);
        maxEntityMassSlider = new Slider(menuX + MENU_WIDTH - 390 - 10, menuY + 105, 390, 25, inputHandler, 1, 5000, 2000);
        maxEntityMassSlider.setBackgroundColorAll(MENU_BACKGROUND);
        minEntitySpeedLabel = new Label(menuX + 5, menuY + 130, 100, 25, "Min Speed: ", OPTION_FONT, inputHandler, MENU_FOREGROUND, MENU_BACKGROUND);
        minEntitySpeedSlider = new Slider(menuX + MENU_WIDTH - 390 - 10, menuY + 130, 390, 25, inputHandler, 1, 30, 1);
        minEntitySpeedSlider.setBackgroundColorAll(MENU_BACKGROUND);
        maxEntitySpeedLabel = new Label(menuX + 5, menuY + 155, 100, 25, "Max Speed: ", OPTION_FONT, inputHandler, MENU_FOREGROUND, MENU_BACKGROUND);
        maxEntitySpeedSlider = new Slider(menuX + MENU_WIDTH - 390 - 10, menuY + 155, 390, 25, inputHandler, 1, 30, 3);
        maxEntitySpeedSlider.setBackgroundColorAll(MENU_BACKGROUND);
        // Buttons:
        applyButton = new Button(menuX + MENU_WIDTH - 70 - 10,
                menuY + MENU_HEIGHT - 25 - 10, 70, 25, inputHandler, "Apply", () -> {
                    applyButtonPressed();
                });
        applyButton.getLabel().foregroundColor = MENU_FOREGROUND;
        toggleGPUButton = new Button(menuX + 10, menuY + MENU_HEIGHT - 25 - 10,
                50, 25, inputHandler, "CPU", () -> {
                    toggleGPUButtonPressed();
                });
        toggleGPUButton.getLabel().foregroundColor = MENU_FOREGROUND;
        // Panel:
        mainMenuPanel = new Panel(menuX, menuY, MENU_WIDTH, MENU_HEIGHT, inputHandler, MENU_BACKGROUND, MENU_BACKGROUND);
